...
namespace ApiCatalogodeJogos.Controllers.V1
{
    ...
    public class CiclodeVidaIDController : ControllerBase
    {
        ...
        public CiclodeVidaIDController(IExemploSingleton exemploSingleton1,
                                       IExemploSingleton exempleSingleton2,
                                       ...
                                       IExemploTransient exemploTransient2)
        {
            ...
            _exemploSingleton2 = exempleSingleton2;
    ...
    public interface IExepmloGeral
    {
        public Guid Id { get; }
    }

    public interface IExemploSingleton : IExepmloGeral
    { }

    public interface IExemploScoped : IExepmloGeral
    { }

    public interface IExemploTransient : IExepmloGeral
    { }
